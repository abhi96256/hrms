...
class SalesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $rows = \App\Models\Inventory\SalesDetail::where(function($query) use($request){
        ...
        $total = \App\Models\Inventory\SalesDetail::where(function($query) use($request){
                      $query->orwhere('sales_id','like',$request['search'])
    ...
    {
        return view('inventory.sales.view');
    }
